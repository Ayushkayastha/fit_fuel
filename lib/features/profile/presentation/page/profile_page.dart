        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text('📊 height: ${user.height.toStringAsFixed(1)}', style: const TextStyle(fontSize: 18)),
              const SizedBox(height: 8),
              Text('📊 weight: ${user.weight.toStringAsFixed(1)}', style: const TextStyle(fontSize: 18)),
            ],
          ),
        ),
      ),
